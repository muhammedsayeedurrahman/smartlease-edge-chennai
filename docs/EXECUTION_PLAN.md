...
| Vision segmenter (YOLOv8n-Seg via PyTorch Lite, CPU) | ✅ DONE, weak, retrained | mask mAP50 **0.249** on a leak-free split (spalling 0.617, crack 0.052); detection threshold 0.55 chosen from the clean-surface false-positive sweep. `ml/vision/handoff/benchmarks/eval_A.json`. |
