...
| Venue AC IR pattern capture | ⛔ OPEN | `WalkthroughScreen.kt` still transmits a generic hardcoded NEC header burst; the finding label itself says "pattern not verified against this unit." Requires being in the room with the actual unit. **Gates your top differentiator.** |
