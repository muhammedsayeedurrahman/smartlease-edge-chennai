...
│
└── Scripts you'll run:
    ├── tools/acoustic_data_tracker.py     # Track recording progress
    ├── tools/download_datasets.py         # Auto-download vision datasets
    └── tools/validate_training_data.py    # Verify data completeness
```
...
python tools/download_datasets.py --manual
```
