...
MAPPING_CONCRETE = {
    0: 2,   # 'chip' -> spalling
    1: 0,   # 'crack' -> crack
    2: 3,   # 'leakage' -> stain_mould
    3: 1,   # 'peeling' -> peeling
    4: 2,   # 'potholes' -> spalling
    5: 1,   # 'protective layer' -> peeling
    6: 3,   # 'rebar corrosion' -> stain_mould
    7: 2,   # 'rebar exposure' -> spalling
    8: 2,   # 'rebar gap' -> spalling
}
...
def merge_datasets(root_dir=".", output_dir="unified_defects"):
    ...
    print("=" * 60)
    print("MERGING DATASETS (1, 2, 3, CONCRETE, PAINT-PEEL) INTO UNIFIED DATASET")
    print("=" * 60)
    ...
    datasets = [
        ...
        ("2", root / "2", MAPPING_2),
        ("3", root / "3", MAPPING_3),
        ("concrete", root / "concrete", MAPPING_CONCRETE),
        ("paint_peel", root / "paint-peel", MAPPING_PAINT_PEEL)
    ]
